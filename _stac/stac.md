...
1. [Prove $|f(y) − f(x)| \leq f(|y − x|)$ if $|y − x| ≤ 1/2$ given $f(x)=-x\log_2 x$][2]: Analyzed the behavior of the inequality and proved a bound with detailed steps and reasoning.
