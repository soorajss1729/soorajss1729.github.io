...
<div class="text-block">
 ...
 <p>These notes are an attempt to organize and share what I’ve learned over the years. They reflect not only the material from Strang's book but also the extended explorations and insights I’ve gained while tackling questions and problems. In addition to core linear algebra topics, I have ventured into related areas such as Fourier series, orthogonal polynomials (Legendre, Hermite, Chebyshev), and special functions. Having enrolled in Math 6108 Applied Matrix Theory at Missouri S&T, my notes extend well beyond the typical scope of a 6000-level advanced graduate course.</p>
</div>
...
function loadPdfPage(url) {
  ...
  <div class="pdf-viewer">
    <iframe src="https://soorajss1729.github.io/pdfjs/viewer.html?file=la1.pdf" width="100%" height="1000px" style="border: none;"></iframe>
  </div>
</div>
